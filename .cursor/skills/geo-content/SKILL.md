---
name: geo-content
description: Write AI Search optimized articles using GEO (Generative Engine Optimization) best practices. Use when creating blog posts, articles, or content that needs to be visible and citable in AI Search engines like ChatGPT, Gemini, and Perplexity.
---
...
1. **Semantic Relevance**: Answer the underlying question, not just keywords
2. **Content Depth**: Comprehensive coverage, not surface-level
3. **Format & Parseability**: Clear structure, headings, lists, tables
4. **Trust & Authority**: E-E-A-T signals, author identity, external validation
5. **Freshness**: Current data and regular updates
6. **Technical Accessibility**: Fast, crawlable, clean markup
7. **Multi-Source Corroboration**: External mentions and validation
8. **Structured Data**: Schema markup for machine readability
